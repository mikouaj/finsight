...
import pl.surreal.finance.transaction.auth.token.AuthTokenAuthenticator;
import pl.surreal.finance.transaction.auth.token.AuthTokenGenerator;
import pl.surreal.finance.transaction.auth.token.JWTTokenDecoder;
